...
function PlayerList:deletePlayerByPos(pos)
...
function PlayerList:getPlayerByUid(uid)
...
function PlayerList:getPlayerByPos(pos)
    for _, player in pairs(self.players) do
...
function PlayerList:setPlayerReady(uid, isReady, data)
